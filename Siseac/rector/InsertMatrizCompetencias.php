...
//   echo "Tus materias selecionada son: rn" .
//        "<ol>";
   
  // $Seani-> obteneMatrizCompetenciaActual($idusuario,$idmateria[2]);
...
////              echo '-';
        ...
        $Seani->obteneMatrizCompetenciaActual($idfic,$estatus,$idusuario,$idmateria[$i],$fecha);    
