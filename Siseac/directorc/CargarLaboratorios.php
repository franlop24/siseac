...
<!--                    <li  ><a href="index.php" > Dashboard </a></li>-->
                             <li class="select"   ><a href="AdminDirectorC.php" style="color: #292929;"> Cargar Horaria</a></li>
                        <li    ><a href="CargaPorDocente.php" > Cargar Por Docente </a></li>
                        <li    ><a href="Cargahoraria.php" > Concetrado Horas </a></li>
 ...
 <?php  $idCarre= $_GET['idCarre']; echo   $idCarre2 = $Seani->Labarotorios($idCarre);                                                          
     echo  "<input type='hidden' value='$idCarre' name='idCarre' />  " ?> 
