...
$Seani->VerificaDesgloseCargaTutores($tutor[$i],$id_conceptoTutor, $id_carrera[$i],$grupoTutor[$i], $fecha, $horas_asignadasTutor,$descripcionTutor, $id_periodo,$horas_asignadasTutor);  
...
$descripcion1m="son asignas de la materia de la materia :";
 ...
 $Seani-> VerificaMateCarga($idDocente[$j],$idMaterias[$j],$fecha,$id_carrera[$j],$idGrupoM[$j]); 
