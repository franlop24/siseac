                ...
                <div id="divCuenta" style="display:none">
                    <?php
                        ...
                        # code...                        
                            ...
                            $Seani->ptcVSpaporCarrera($filax[0],$abrevia[0],'');     //se quita parametro
                        //echo '<hr>';
                        }
                        echo "</table>";
                    ?>
                <!--<hr>
                  <?php //echo $ConsultaHoras = $Seani->ptcVSpa(10); //se agreg parametro?>
                <hr>-->
              </div>
            ...
            <button id="ExportaEX">EXCEL</button>
              ...
              <table id="tableConten" class="table table-bordered table-striped  data_table3"  >
                ...
                <tbody align="center">
                  ...
                  <?php   echo   $DatosPersonaleTabla = $Seani->ReporteporDirector($idusuario); //se quitó parametro    ?>     
