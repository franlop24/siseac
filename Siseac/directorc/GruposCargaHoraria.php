<?php
  ...
  if (!$_SESSION["account_name"]) {   //    header('Location: ../index.php');
      echo '<script type="text/javascript">';
      echo 'alert("No has iniciado sesión' . $error . '");';
      echo 'window.location.assign("../index.php");';
      echo '</script>';    
  } else if ($_SESSION["tipo_usuario"] != 2) {  // create SESSION  
      echo '<script type="text/javascript">';
           ...
           <!-- End Header -->
              ...
              <div id="left_menu">
                <ul id="main_menu" class="main_menu">
                  ...
                  <li class="select"   ><a href="AdminDirectorC.php" style="color: #292929;"> Carga Horaria</a></li>
              ...
              <div id="content" >
               ...
               <?php include_once('include/menu.php'); ?>
                    ...
                    <div class="row-fluid">
                     ...
                     $idCarre = $Seani->GruposPorCarrer($idCarre);     ?>                                                       
