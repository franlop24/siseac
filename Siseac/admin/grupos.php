               ...
               <?php include_once('include/menu.php'); ?>
                    	...
                    	<!-- Table widget -->
                            <div class="widget  span12 clearfix">
                                ...
                                <div class="widget-header">
                                    <span><i class="icon-table"></i> Administrador de Grupos </span>
                  ...
                  <?php 
                   ...
                   <div style="width: 45%; float:left;">
                    ...
                    <h2>Periodos</h2><select name="peri" id="peri">
                      <?php 
                  ...
                  <div id="nuevoG" style="width: 49%; float: left; padding: 10px;">
                    Cuatrimestre
                 ...
                 <div id="grupos" style="width: 49%; float:right; height: 300px; overflow: auto;">
