...
<!--                      <li class="select" ><a href="#"style="color: #292929;" ><b>Dashboard</b></a></li>-->
                    <li  ><a href="index.php" style="color: #292929;"> Dashboard </a></li>
                       <li   ><a href="AdminDocentes.php" > Administrar Docentes </a></li>
                         <li class="select"   ><a href="AdminPeriodoEscolar.php" > Administar Periodo Escolar </a></li>
              ...
              <div id="content" >
               ...
               <?php include_once('include/menu.php'); ?>
                    ...
                    <div class="row-fluid">
                          ...
                          // $periodo=10;  //cambio de periodo
                           
                     $idCarre = $Seani->GruposPorCarrer($idCarre);  //Se quita parametro   ?>                                                       
