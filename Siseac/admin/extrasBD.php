...
if($_POST['opcion']==1)
{
	...
	$idregresado = $Seani->obtieneIdProyecto($id_carrera,$id_docente,$id_concepto);	//se quitó parametro
	...
	echo $idregresado; 
        ...
        $actualizacion = date('Y-m-d H:i:s');
  		...
  		$Seani->VerificaCargaIndividual($id_docente,$id_concepto, $id_carrera, $actualizacion, $horas_asignadas, $descripcion); 	//Se quitó parametro
