...
<!--                    <li  ><a href="index.php" > Dashboard </a></li>-->
                        <li class="select"   ><a href="AdminDirectorC" style="color: #292929;"> Cargar Horaria</a></li>
                        <li    ><a href="CargaPorDocente.php" > Cargar Por Docente </a></li>
              ...
              <div id="content" >
               ...
               <?php include_once('include/menu.php'); ?>
                    ...
                    <div class="row-fluid">
                      ...
                      <form id="validation_demo" action="guardaTutores.php" method="post" >   
                                                <table class="table table-bordered table-striped  data_table3" >
                                                      ...
                                                      <thead>
                                                         ...
                                                         <th>  Profesores que imparte </th>
                                                          </tr>
                                                      </thead>
                                                      <tbody align="center">
                              
                                    <?php   $idCarre= $_GET['idCarre'];   $cuatrimestre= $_GET['cuatrimestre']; echo   $idCarre = $Seani->MateriasDocenteGrupo($idCarre,$cuatrimestre);     ?>    
                                ...
                                <input class="btn submit_form" type="submit" value="Guardar" />
                                   </form>  
