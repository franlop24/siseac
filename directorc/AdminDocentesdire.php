  ...
  <body>        
    ...
    <div id="left_menu">
      <ul id="main_menu" class="main_menu">
        ...
        <li><a href="AdminDirectorC.php"> Carga Horaria</a></li>
        <li><a href="CargaPorDocente.php"> Carga Por Docente </a></li>
        <li><a href="Cargahoraria.php"> Concentrado </a></li>
        <li class="select"><a href="AdminDocentesdire.php" style="color: #292929;" > Listado de Docentes </a></li>
      </ul>
    </div>
                  ...
                  <div id="tab1" class="tab_content"> 
                    <table class="table table-bordered table-striped  data_table3" >
                      ...
                      <tbody align="center">
                        ...
                        <?php   echo   $DatosPersonaleTabla = $Seani->ObtenerDatosDocentes();     ?>     
