...
if($_POST['opcion']==1)
{
	...
	$idregresado = $Seani->obtieneIdProyecto($id_carrera,$id_docente,$id_concepto,15);	//se agregó prmetro
	...
	echo $idregresado; 
        ...
        $actualizacion = date('Y-m-d H:i:s');
  		...
  		$Seani->VerificaCargaIndividual(15,$id_docente,$id_concepto, $id_carrera, $actualizacion, $horas_asignadas, $descripcion); 
	...
	$cacha = $Seani->VerificaExisteConcepto($id_docente, $id_carrera, $id_concepto, 15);	//Se agregó parámetro
