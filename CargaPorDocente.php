...
<!--                    <li  ><a href="index.php" > Dashboard </a></li>-->
    <li    ><a href="AdminDirectorC.php"> Cargar Horaria</a></li>
                        <li class="select"   ><a href="CargaPorDocente.php"  style="color: #292929;"> Cargar Por Docente </a></li>
  ...
  echo ' <div class="section">';
         ...
         $materia=$_GET['materia'];
                 echo '       </div>  ';
         echo '       </div>  ';
         $Carreras = $Seani->CarreraPorDirectorSelect($idusuario); 
	...
	Cronogramas de Actividades,
        Entregables.
          ...
          <input class="btn submit_form"   disabled type="submit" value="Guardar Carga Horaria" />  
    </form>
