...
if($_POST['opcion']==1)
{
	...
	$idregresado = $Seani->obtieneIdProyecto($id_carrera,$id_docente,$id_concepto,10);	//se agregó parametro
	...
	echo $idregresado; 
        ...
        $actualizacion = date('Y-m-d H:i:s');
  		...
  		$Seani->VerificaCargaIndividual(10,$id_docente,$id_concepto, $id_carrera, $actualizacion, $horas_asignadas, $descripcion); 
	...
	$cacha = $Seani->VerificaExisteConcepto($id_docente, $id_carrera, $id_concepto, 10);	//se agregó parámetro
