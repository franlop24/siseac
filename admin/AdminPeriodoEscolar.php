...
<!--                      <li class="select" ><a href="#"style="color: #292929;" ><b>Dashboard</b></a></li>-->
                    <li   ><a href="index.php" > Dashboard </a></li>
                       <li   ><a href="AdminDocentes.php" > Administrar Docentes </a></li>
                         <li class="select"   ><a href="AdminPeriodoEscolar.php" style="color: #292929;" > Administar Periodo Escolar </a></li>
                                      <li ><a href="AdminDocentes.php" > Bloqueo Carga Horaria </a></li>
                    	...
                    	<!-- Table widget -->
                            <div class="widget  span12 clearfix">
                                ...
                                <div class="widget-header">
                                    <span><i class="icon-table"></i> Administración Periodos Escolares </span>
                                ...
                                <div class="widget-content">
                                          ...
                                          <form action="GuardaAdminPeriodoEscolar.php" method="post">   
      ...
      <?php  $idCarre= $_GET['idCarre']; echo   $idCarre2 = $Seani->SelecionarPeriodo(); ?> 
