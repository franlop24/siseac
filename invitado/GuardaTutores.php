...
$Seani->VerificaDesgloseCargaTutores(1,$tutor[$i],$id_conceptoTutor, $id_carrera[$i],$grupoTutor[$i], $fecha, $horas_asignadasTutor,$descripcionTutor);  
...
$descripcion1m="son asignas de la materia de la materia :";
 ...
 $horasemana=$horas_por_semana[$j];
      $materias=$Seani->VerificaDesgloseCargas(1,$idDocente[$j],$id_conceptoMateriaHfg,$id_carrera[$j],$idMaterias[$j],$idGrupoM[$j],$fecha,$horas_por_semana[$j],$descripcionMaterias); 
        $asesoria= $Seani->VerificaDesgloseCargas(1,$idDocente[$j],$id_conceptoMateriaAsesorias,$id_carrera[$j],$idMaterias[$j],$idGrupoM[$j],$fecha,$horas_asignadasAsesorias,$descripcionAsesorias);           
