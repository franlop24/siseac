...
<!--                      <li class="select" ><a href="#"style="color: #292929;" ><b>Dashboard</b></a></li>-->
                       ...
                       <li class="select"  ><a style="color: #292929;"href="AdminDocentes.php" > Administrar Docentes </a></li>
...
//                                                                       
 ...
 <table class="table table-bordered table-striped  data_table3" >
     <CAPTION><h2>Grados Académicos</h2></CAPTION>
                                                      <thead>
                                                          <tr>
                                                              <th>Grado</th>
                                                              <th>Institución</th>
                                                      ...
                                                      <tbody align="center">
                                                             ...
                                                             <?php   echo   $DatosPersonaleMatrizCompetencia = $Seani->ObtenerGradorAcademico($idTabUser);     ?>     
                                             ...
                                             <table class="table table-bordered table-striped  data_table3" >
                                                     <CAPTION><h2>
                                                      ...
                                                      <tbody align="center">
                                                             ...
                                                             <?php   echo   $DatosPersonaleMatrizCompetencia = $Seani->ObtenerCarrerraAcademica($idTabUser);     ?>     
                                               ...
                                               <table class="table table-bordered table-striped  data_table3" >
                                                     <CAPTION><h2>
                                                            Materias Impartidas</h2></CAPTION>
                                                      <thead>
                                                          <tr>
                                                      ...
                                                      <tbody align="center">
                                                             ...
                                                             <?php   echo   $DatosPersonaleMatrizCompetencia = $Seani->ObtenerMateriasImpartidas($idTabUser);     ?>     
